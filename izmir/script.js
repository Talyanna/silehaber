...
async function getWeather() {
    ...
    const url =
        ...
        `?latitude=${IZMIR.latitude}` +
        `&longitude=${IZMIR.longitude}` +
...
async function getDutyPharmacies() {
    ...
    list.innerHTML = `
        ...
        <div class="loading-card">
            ...
            İzmir nöbetçi eczaneleri yükleniyor...
    ...
    const url =
        "https://eczaneadresi.com/api/public/v1/duty-pharmacies?city=izmir&limit=200";
    ...
    try {
        ...
        /*
            API iki farklı yapıda cevap döndürse de
            sistem çalışabilsin diye ikisini de kontrol ediyoruz.
        */
        ...
        setText(
            ...
            pharmacies.length
                ? `Bugün İzmir genelinde ${pharmacies.length} nöbetçi eczane listeleniyor.`
        ...
        setText(
            "pharmacy-panel-description",
            "İzmir nöbetçi eczane verisine şu anda ulaşılamıyor."
        );
